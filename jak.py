...
#       TODO
#       FIX
#       check if window manager supports composing
#       hint type dock remove box shadow, need to find thr right css class.
#       hint type dock and desktop transparency window appears black, this needs more testing maybe using cairo is a better option.
#
#       ENHANCEMENTS
#       implement distraction mode view with f11
#
...
w = Gtk.Window
path = os.getcwd()
JAK_URL = "https://github.com/vmnlopes/jade-Application-Kit"
...
class AppWindow(w):
    ...
    def __init__(self):  # Create window frame
        ...
        if get_hint_type == "desktop":
            ...
            MADE_WITH.set_markup(MADE_WITH_MSG + "Jade Application Kit " + "<a href=" + "'" + JAK_URL + "'" + ">" + JAK_URL + "</a>")
